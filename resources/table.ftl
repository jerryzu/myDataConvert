...
<#if ((field.precision!0) == 0) || ((field.scale!0) == 0)> 
`${field.fieldname}` ${field.datatype}<#if field_has_next>,</#if>
<#elseif field.scale == 0>			
`${field.fieldname}` ${field.datatype}(${field.precision})  comment  '${field.fielddesc!""}' <#if field_has_next>,</#if>
<#else>			
`${field.fieldname}` ${field.datatype}(${field.precision},${field.scale})   comment  '${field.fielddesc!""}' <#if field_has_next>,</#if>
</#if>
<#else>
